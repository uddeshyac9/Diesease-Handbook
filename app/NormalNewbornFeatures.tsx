...
// Top-level keys of the JSON describe each feature category
const headings: string[] = Object.keys(featuresJson.normal_newborn_features);
...
export default function NormalNewbornFeatures() {
  ...
  // When a category is selected, render its details
  if (selected) {
  ...
  // Default:grid of feature categories
  return (
    <SafeAreaView style={styles.safeArea}>
